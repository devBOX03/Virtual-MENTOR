...
<div style="margin-top:-2px;margin-left:71px;border:1px solid #415677;width:900px;height:auto;">
...
for(UserInfo u_info : list){
	...
	<tr class='clickable-row' data-href='mentorPanel/PerformancePanel.jsp?uid=<%=u_info.getId()%>&name=<%=u_info.getName() %>'>
		<td><%=u_info.getId() %></td>
