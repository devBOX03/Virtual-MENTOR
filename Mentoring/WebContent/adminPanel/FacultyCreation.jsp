...
<form action="FacultyCreation" method="post">
			...
			<td><input type="password" style="width:223px;height:18px;" name="Password"></td>
			</tr>
			<tr>
			<td style="background-color:#a2b3c4;display: inline-block;padding:5px 5px;width:170px;
			...
			<input type="submit" style="width:150px;height:25px;background-color:#4189fc;color : white;" name="save" /></td>
			</tr>
			</table>
