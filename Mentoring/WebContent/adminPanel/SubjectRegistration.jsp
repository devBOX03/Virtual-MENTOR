...
<div class="border2" style="height: 250px;">
<form action="SubjectRegistration" method="post">
<table style="margin-left:20px;margin-top:20px;">
<tbody>
	<tr><td class="rowtable2">Department </td>
		<td>
	...
	<td class="rowtable2">Semester</td>
		...
		<td></td>
		<td></td>
	<td class="rowtable2" >Year</td>
		<td><input type="text" style="width:65px;height:18px;" name="year"></td>
	</tr>
	</tbody>
	</table>
...
<input type="submit" style="width:150px;height:25px;background-color:#4189fc;color : white;" value="Register">
</div>
