...
<td><input type="text" style="width:152px;height:15px;margin-top:-2px;" name="year"></td>
</tr>
</tbody>
</table>
...
<div style="margin-left:870px;margin-top:5px;"><input type="submit" style="width:150px;height:25px;background-color:#4189fc;color : white;" name="Assign"></div>
</form>
</div>
</body>
</html>