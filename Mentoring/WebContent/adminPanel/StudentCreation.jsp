...
<form action="StudentCreation" method="post">
			...
			<table style="margin-left:5px;">
			<tr>
			<td class="rowtable2" style="width: 123px;">Father`s Name</td>
			<td><input type="text" style="width:160px;height:18px;" name="Father_Name"></td>
			<td></td>
			<td></td>
			<td class="rowtable2">Father`s No. </td>
			<td><input type="number" style="width:160px;height:18px;" name="Father_PhoneNumber" ></td>
			<td></td>
			<td></td>
			<td class="rowtable2" style="width: 123px;">Father`s Email</td>
			<td><input type="email" style="width:160px;height:18px;" name="Father_email" placeholder="@email"></td>
			</tr>
			<tr>
			<td class="rowtable2" style="width: 123px;">Mother`s Name</td>
			<td><input type="text" style="width:165px;height:18px;" name="Mother_Name"></td>
			<td></td>
			<td></td>
			<td class="rowtable2">Mother`s No.</td>
			<td><input type="number" style="width:165px;height:18px;" name="Mother_PhoneNumber" ></td>
			<td></td>
			<td></td>
			<td class="rowtable2" style="width: 123px;">Mother`s Email</td>
			...
			<input type="submit" style="width:150px;height:25px;background-color:#4189fc;color : white;" name="save" /></div>
			</fieldset>
		</form>
</div>
</body>
