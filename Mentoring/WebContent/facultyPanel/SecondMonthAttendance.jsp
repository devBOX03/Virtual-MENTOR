...
<div style="margin-left:25px;margin-top:50px;border:1px solid;
		...
		color:white;font-size:18px;border-top-right-radius:10em;">Second Month Attendance</div>
		<hr style="margin-left:26px;margin-top:-2px;border-color:#415677;width:1050px;">
<form action="SecondMonthAttendance" method="post">
...
<div style="background-color:#a2b3c4;
	...
	width:240px;
	height:30px;
	font-size:14px;margin-top:15px;margin-left:200px;padding-left:40px;">Total Classes Happened</div><input type="text" style="margin-left:30px;width:300px;height:32px;" name="totalClasses">
...
<div>
<input type="submit" style="margin-left:500px;margin-top:25px;margin-bottom: 10px;" class="btn btn-info" value="Submit Attendance"></div>
</form>
</body>
</html>